//
//  TiktokNotableLikersCollectionViewCell.swift
//  Infpromo
//
...
class TiktokNotableLikersCollectionViewCell: UICollectionViewCell {
    static let reuseIdentifier = "tiktokNotableLikersCollectionViewCellIdentifier"
