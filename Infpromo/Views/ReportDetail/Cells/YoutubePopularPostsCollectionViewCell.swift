//
//  YoutubePopularPostsCollectionViewCell.swift
//  Infpromo
//
...
class YoutubePopularPostsCollectionViewCell: UICollectionViewCell {
    static let reuseIdentifier = "youtubePopularPostsCollectionViewCellIdentifier"
...
//        secondStackView.addSubview(commentslabel)
    ...
    func configureCell(with viewModel: YoutubePopularPostsViewModel) {
