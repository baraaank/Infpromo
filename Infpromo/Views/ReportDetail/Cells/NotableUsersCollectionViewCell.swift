//
//  NotableUsersCollectionViewCell.swift
//  Infpromo
//
...
class NotableUsersCollectionViewCell: UICollectionViewCell {
    static let reuseIdentifier = "notableUsersCollectionViewCellIdentifier"
