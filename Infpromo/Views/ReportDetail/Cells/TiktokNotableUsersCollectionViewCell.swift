//
//  TiktokNotableUsersCollectionViewCell.swift
//  Infpromo
//
...
class TiktokNotableUsersCollectionViewCell: UICollectionViewCell {
    static let reuseIdentifier = "tiktokNotableUsersCollectionViewCellIdentifier"
