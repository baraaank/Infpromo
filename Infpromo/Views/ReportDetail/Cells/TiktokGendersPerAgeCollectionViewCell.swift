//
//  TiktokGendersPerAgeCollectionViewCell.swift
//  Infpromo
//
...
class TiktokGendersPerAgeCollectionViewCell: UICollectionViewCell {
    static let reuseIdentifier = "tiktokGendersPerAgeCollectionViewCellIdentifier"
