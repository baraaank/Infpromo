//
//  YoutubeNotableUsersCollectionViewCell.swift
//  Infpromo
//
...
class YoutubeNotableUsersCollectionViewCell: UICollectionViewCell {
    static let reuseIdentifier = "youtubeNotableUsersCollectionViewCellIdentifier"
