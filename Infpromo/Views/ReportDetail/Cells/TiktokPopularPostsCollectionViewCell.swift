//
//  TiktokPopularPostsCollectionViewCell.swift
//  Infpromo
//
...
class TiktokPopularPostsCollectionViewCell: UICollectionViewCell {
    static let reuseIdentifier = "tiktokPopularPostsCollectionViewCellIdentifier"
