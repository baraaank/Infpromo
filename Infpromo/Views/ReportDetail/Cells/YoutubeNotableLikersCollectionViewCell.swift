//
//  YoutubeNotableLikersCollectionViewCell.swift
//  Infpromo
//
...
class YoutubeNotableLikersCollectionViewCell: UICollectionViewCell {
    static let reuseIdentifier = "youtubeNotableLikersCollectionViewCellIdentifier"
