//
//  YoutubeFollowersFilterCollectionViewCell.swift
//  Infpromo
//
...
class YoutubeFollowersFilterCollectionViewCell: UICollectionViewCell {
    static let reuseIdentifier = "youtubeFollowersFilterCollectionViewCellIdentifier"
