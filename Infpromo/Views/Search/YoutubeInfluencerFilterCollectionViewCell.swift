//
//  YoutubeInfluencerFilterCollectionViewCell.swift
//  Infpromo
//
...
class YoutubeInfluencerFilterCollectionViewCell: UICollectionViewCell {
    static let reuseIdentifier = "youtubeInfluencerFilterCollectionViewCellIdentifier"
