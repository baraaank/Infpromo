...
class YoutubeSearchViewController: UIViewController {
    ...
    private let tableView: UITableView = {
        ...
        tableView.register(YoutubeSearchTableViewCell.self, forCellReuseIdentifier: YoutubeSearchTableViewCell.reuseIdentifier)
...
extension YoutubeSearchViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: YoutubeSearchTableViewCell.reuseIdentifier, for: indexPath) as! YoutubeSearchTableViewCell
